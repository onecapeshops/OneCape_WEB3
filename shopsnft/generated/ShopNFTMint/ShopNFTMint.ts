...
export class ShopNFTMint extends ethereum.SmartContract {
  ...
  _listedTokens(param0: BigInt): boolean {
    let result = super.call("_listedTokens", "_listedTokens(uint256):(bool)", [
  ...
  try__listedTokens(param0: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "_listedTokens",
      "_listedTokens(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  _openListings(param0: BigInt): BigInt {
    let result = super.call(
      "_openListings",
      "_openListings(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try__openListings(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_openListings",
      "_openListings(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  getListedTokenIds(_id: BigInt): boolean {
    let result = super.call(
      "getListedTokenIds",
      "getListedTokenIds(uint256):(bool)",
  ...
  try_getListedTokenIds(_id: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "getListedTokenIds",
      "getListedTokenIds(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(_id)]
  ...
  getMarketplaceItemsCount(): BigInt {
    let result = super.call(
      "getMarketplaceItemsCount",
      "getMarketplaceItemsCount():(uint256)",
      []
    );
  ...
  try_getMarketplaceItemsCount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getMarketplaceItemsCount",
      "getMarketplaceItemsCount():(uint256)",
      []
  ...
  getNFTDetails(id: BigInt): ShopNFTMint__getNFTDetailsResultValue0Struct {
    let result = super.call(
      "getNFTDetails",
      "getNFTDetails(uint256):((uint256,string,address,address,bool,bool))",
      [ethereum.Value.fromUnsignedBigInt(id)]
    );
  ...
  getNFTOrderBookDetails(
    ...
    let result = super.call(
      "getNFTOrderBookDetails",
      "getNFTOrderBookDetails(uint256):((uint256,uint256,address,bool,uint256,uint256,bool))",
      [ethereum.Value.fromUnsignedBigInt(id)]
    );
  ...
  getOpenListings(): Array<BigInt> {
    let result = super.call(
      "getOpenListings",
      "getOpenListings():(uint256[])",
      []
    );
  ...
  try_getOpenListings(): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "getOpenListings",
      "getOpenListings():(uint256[])",
      []
  ...
  nftLogs(param0: BigInt): ShopNFTMint__nftLogsResult {
    let result = super.call(
      "nftLogs",
      "nftLogs(uint256):(uint256,string,address,address,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  salesList(param0: BigInt): ShopNFTMint__salesListResult {
    let result = super.call(
      "salesList",
      "salesList(uint256):(uint256,uint256,address,bool,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
...
export class ChangeNFTRentedCall extends ethereum.Call {
  get inputs(): ChangeNFTRentedCall__Inputs {
    return new ChangeNFTRentedCall__Inputs(this);
  }

  get outputs(): ChangeNFTRentedCall__Outputs {
    return new ChangeNFTRentedCall__Outputs(this);
  }
}

export class ChangeNFTRentedCall__Inputs {
  _call: ChangeNFTRentedCall;

  constructor(call: ChangeNFTRentedCall) {
    this._call = call;
  }
...
export class ChangeNFTRentedCall__Outputs {
  _call: ChangeNFTRentedCall;
...
export class SetRentalNFTContractCall extends ethereum.Call {
  get inputs(): SetRentalNFTContractCall__Inputs {
    return new SetRentalNFTContractCall__Inputs(this);
  }

  get outputs(): SetRentalNFTContractCall__Outputs {
    return new SetRentalNFTContractCall__Outputs(this);
  }
}

export class SetRentalNFTContractCall__Inputs {
  _call: SetRentalNFTContractCall;

  constructor(call: SetRentalNFTContractCall) {
    this._call = call;
  }

  get _rentalContract(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetRentalNFTContractCall__Outputs {
  _call: SetRentalNFTContractCall;
